package com.ershgem.mf.entity.dragons.queens_crown;
...
public class QueensCrownDragon extends TamableAnimal implements Saddleable, FlyingAnimal, PlayerRideableJumping, IAnimatable {
    ...
    // data value IDs
    private static final EntityDataAccessor<String> DATA_BREED = SynchedEntityData.defineId(QueensCrownDragon.class, EntityDataSerializers.STRING);
    private static final EntityDataAccessor<Boolean> DATA_FLYING = SynchedEntityData.defineId(QueensCrownDragon.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> DATA_SADDLED = SynchedEntityData.defineId(QueensCrownDragon.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> DATA_AGE = SynchedEntityData.defineId(QueensCrownDragon.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> IS_GOINGUP = SynchedEntityData.defineId(QueensCrownDragon.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> IS_HOVERING = SynchedEntityData.defineId(QueensCrownDragon.class, EntityDataSerializers.BOOLEAN);
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        if(this.isFlying()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("flight.queenscrown_model", true));
    ...
    public QueensCrownDragon(EntityType<? extends TamableAnimal> type, Level level) {
        super(type, level);
        this.maxUpStep = 1;
        this.noCulling = true;
        this.fireImmune();
        this.moveControl = new QueensCrownMoveController(this);
        this.setTame(false);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob p_146744_) {
        return ModEntities.QUEENS_CROWN.get().create(serverLevel);
    }
