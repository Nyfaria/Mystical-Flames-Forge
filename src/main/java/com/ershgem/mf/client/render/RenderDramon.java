...
public class RenderDramon extends GeoEntityRenderer<EntityDramon> {
    public RenderDramon(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DramonModel());
    }

    @Override
    public RenderType getRenderType(EntityDramon animatable, float partialTicks, PoseStack stack,
