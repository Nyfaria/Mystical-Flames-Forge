...
public class RenderPhoenix extends GeoEntityRenderer<EntityPhoenix> {
    public RenderPhoenix(EntityRendererProvider.Context renderManager) {
        super(renderManager, new PhoenixModel());
    }

    @Override
    public RenderType getRenderType(EntityPhoenix animatable, float partialTicks, PoseStack stack,
