...
public class QueensCrownMoveController extends MoveControl
{
    private final QueensCrownDragon dragon;

    public QueensCrownMoveController(QueensCrownDragon dragon)
    {
        super(dragon);
        this.dragon = dragon;
    }
