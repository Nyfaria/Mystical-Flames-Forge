...
public class RenderLycan extends GeoEntityRenderer<LycanDragon>
{
    ...
    @Override
    public RenderType getRenderType(LycanDragon animatable, float partialTicks, PoseStack stack,
