...
public class ModItems {
    ...
    public static final RegistryObject<ForgeSpawnEggItem> ETERNAL_FLAME_SPAWN = ITEMS.register("eternal_flame_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.ETERNAL_FLAME, 0x464849, 0x793c98, new Item.Properties().tab(ModCreativeModeTab.MF_SPAWN_EGGS).stacksTo(64)));
