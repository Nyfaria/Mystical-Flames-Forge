package com.ershgem.mf.entity.dragons.kelptolux;
...
public class KelptoluxDragon extends TamableAnimal implements Saddleable, FlyingAnimal, PlayerRideableJumping, IAnimatable {
    ...
    // data value IDs
    private static final EntityDataAccessor<String> DATA_BREED = SynchedEntityData.defineId(KelptoluxDragon.class, EntityDataSerializers.STRING);
    private static final EntityDataAccessor<Boolean> DATA_FLYING = SynchedEntityData.defineId(KelptoluxDragon.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> DATA_SADDLED = SynchedEntityData.defineId(KelptoluxDragon.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> DATA_AGE = SynchedEntityData.defineId(KelptoluxDragon.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> IS_GOINGUP = SynchedEntityData.defineId(KelptoluxDragon.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> IS_HOVERING = SynchedEntityData.defineId(KelptoluxDragon.class, EntityDataSerializers.BOOLEAN);
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        if(this.isFlying()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("fly.Kelptolux_Model", true));
    ...
    public KelptoluxDragon(EntityType<? extends TamableAnimal> type, Level level) {
        super(type, level);
        this.maxUpStep = 1;
        this.noCulling = true;
        this.fireImmune();
        this.moveControl = new KelptoluxMoveController(this);
        this.setTame(false);
    }
